...
export default component$(() => {
    ...
    const handleEmailSignup = $(async(event: any) => {
        ...
        // Terms validation
        if(!isTerms){
            message.message = "You must agree to our terms, privacy and disclamer before signing up";
            isLoading.value= false;
            return;
        }
        ...
        const pwd = (Math.floor(Math.random() * 1000000) + email + timestamp).toString();
